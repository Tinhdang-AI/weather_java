...
public class WeatherApp {
    ...
    public static JSONObject getWeatherData(String locationName){
        ...
        String urlString = "https://api.open-meteo.com/v1/forecast?" +
                ...
                "&hourly=temperature_2m,relativehumidity_2m,weathercode,windspeed_10m,soil_temperature_0cm&timezone=Europe%2FBerlin";
    ...
    //retrieves geographic coordinates ofr given location name
    ...
    public static String getCurrentTime(){
        ...
        //format date to be 2023-09-02T00:00 (this is how is it read in the API)
